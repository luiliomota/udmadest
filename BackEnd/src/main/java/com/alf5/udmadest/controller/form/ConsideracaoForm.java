...
public class ConsideracaoForm {
    ...
    public Consideracao registrar(ConsideracaoRepository consideracaoRepository, MesReferenciaRepository mesReferenciaRepository) {
        Consideracao consideracao = new Consideracao();
        consideracao.setDescricao(this.descricao);
        if (this.dataConsideracao != null) {
